        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="ins-package.php" method="post" enctype="multipart/form-data">
                        <p>Package Name</p>
                        ...
                        <p>Food Type</p>
                        <p><input type="radio" name="foodtype" value="Veg"> Veg</p>
                        <p><input type="radio" name="foodtype" value="Non-Veg"> Non-Veg</p>
